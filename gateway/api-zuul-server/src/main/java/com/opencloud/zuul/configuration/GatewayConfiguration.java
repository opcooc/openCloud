...
import com.opencloud.zuul.actuator.ApiEndpoint;
import com.opencloud.zuul.filter.ModifyHeaderFilter;
...
import com.opencloud.zuul.locator.ResourceLocator;
...
public class GatewayConfiguration {
    ...
    public ResourceLocator resourceLocator(GatewayServiceClient gatewayServiceClient) {
        ResourceLocator resourceLocator = new ResourceLocator(jdbcRouteLocator, rateLimitProperties, systemAuthorityServiceClient, gatewayServiceClient);
